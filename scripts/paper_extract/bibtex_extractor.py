...
def process_bibtex_file(input_bib_path, output_jsonl_path, is_gzipped, parser_mode, overwrite_flag):
    ...
    try:
        ...
        bib_content_str = ""
        with open(actual_bib_path_to_parse, 'r', encoding='utf-8') as bibtex_file:
...
if __name__ == "__main__":
    ...
    input_file = f"../../../data/rss_paper_data/anthology+abstracts.bib"
    output_file = f"../../../data/rss_paper_data/acl_papers_w_abstracts.t0.jsonl"
